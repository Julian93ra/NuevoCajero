var cuentas = [
    {identificador:1, nombre:'Mali', Saldo:200, password:'1234'},
    {identificador:2, nombre:'Gera', Saldo:290, password:'5678'},
    {identificador:3, nombre:'Maui', Saldo:67, password:'9101'}
]
...
function inicio() {
    ...
    cuentas.forEach(function(cuenta){
        agregarOpciones(cuenta.identificador,cuenta.nombre)
        }
    )
}
function Login(){
...
function Saldo(indice){
    ...
    let mensajeSaldo = "<p> Usuario: <label>" + nombreUsuario + "</label><br> Saldo: <label>" + saldoUsuario + "</label> </p><br>"
...
function cancelarConsignar(){
    ...
    Saldo(inputUsuarioSesion.value)
}
